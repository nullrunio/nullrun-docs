...
free with hard limits (3 workflows, 500 decisions/month). Pro and
Enterprise are paid plans with the same surface — no feature gating
behind a trial state. See `billing.md` in the gateway repo for
limits.
